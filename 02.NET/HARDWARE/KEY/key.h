...
#define CKECK1_GPIO_CLK RCC_APB2Periph_GPIOA
#define CKECK1_GPIO_PORT GPIOA
#define CKECK1_GPIO_PIN GPIO_Pin_0

#define CKECK2_GPIO_CLK RCC_APB2Periph_GPIOA
#define CKECK2_GPIO_PORT GPIOA
#define CKECK2_GPIO_PIN GPIO_Pin_3

#define CKECK3_GPIO_CLK RCC_APB2Periph_GPIOA
#define CKECK3_GPIO_PORT GPIOA
#define CKECK3_GPIO_PIN GPIO_Pin_4

#define CKECK4_GPIO_CLK RCC_APB2Periph_GPIOA
#define CKECK4_GPIO_PORT GPIOA
#define CKECK4_GPIO_PIN GPIO_Pin_5
...
#define CKECK1 GPIO_ReadInputDataBit(GPIOA, CKECK1_GPIO_PIN) // 读取按键0
#define CKECK2 GPIO_ReadInputDataBit(GPIOA, CKECK2_GPIO_PIN) // 读取按键1
#define CKECK3 GPIO_ReadInputDataBit(GPIOA, CKECK3_GPIO_PIN) // 读取按键2
#define CKECK4 GPIO_ReadInputDataBit(GPIOA, CKECK4_GPIO_PIN) // 读取按键2
